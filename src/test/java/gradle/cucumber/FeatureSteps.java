        ...
        if (roll == 1) {
            ...
            while (count < players.size()) {
                ...
                if (players.get(index).owns("Cafe")) {
                    int mod = (players.get(index).owns("Shopping Mall"))? 1 : 0; // Atlas 1 : 0
        ...
        while (output.hasNext()) {
            ...
            if (line.contains("Choose a number to purchase or construct")) {
                ...
                if (!guessLow) {
                    ...
                    System.out.println("::::::::::::::::::::::::::::::::::::::::::     ENTER " + options.size());
                    input.println("" + options.size());
                    guessHigh = true;
                } else {
                    System.out.println("::::::::::::::::::::::::::::::::::::::::::     " + options.keySet());
                    System.out.println("::::::::::::::::::::::::::::::::::::::::::    ENTER " + options.keySet().contains("City Hall"));
                    if (options.keySet().contains("City Hall")) {
                        System.out.println("::::::::::::::::::::::::::::::::::::::::::    HALLELUJAH!!!");
                        System.out.println("::::::::::::::::::::::::::::::::::::::::::    ENTER " + options.get("City Hall"));
                        ...
                        for (String option : options.keySet()) {
                            if (players.get(playerNum).copies(option) < 2 && !chosen) {
                                ...
                                System.out.println("::::::::::::::::::::::::::::::::::::::::::    ENTER " + options.get(option));
                                chosen = true;
                            }
                        }
                        if (!chosen) {
            ...
            if (line.contains("Choose a number to purchase or construct")) {
                ...
                for (String landmark : landmarks) {
                    if (options.keySet().contains(landmark) && !players.get(playerNum).owns(landmark) && ownsHigherPriority) {
                        ...
                        System.out.println("::::::::::::::::::::::::::::::::::::::::::     ENTER " + options.get(landmark));
            ...
            if (line.contains("Choose a number to purchase or construct")) {
                ...
                for (String landmark : landmarks) {
                    if (options.keySet().contains(landmark) && !players.get(playerNum).owns(landmark) && ownsHigherPriority) {
                        input.println(options.get(landmark));
                        System.out.println("::::::::::::::::::::::::::::::::::::::::::     ENTER " + options.get(landmark));
                        System.out.println("After what the player should have entered");
                        players.get(playerNum).add(landmark);
                        boughtLandmark = true;
                        if (landmarkCount == landmarks.size() - 1) {
                            playerOneWins = (playerNum == 0);
                ...
                if (!boughtLandmark) {
                    boolean chosen = false;
                    int minimum = players.get(playerNum).owns("Shopping Mall")? 0 : 1;
                    for (String option : options.keySet()) {
                        System.out.println("Noah " + option);
